Public Class Retailer_OrderForm
    ...
    Private Sub ButtonAddStudent_Click(sender As Object, e As EventArgs) Handles ButtonAddOrder.Click
        ...
        If (student.addItems(ComboBox1.Text, amount_1, ComboBox2.Text, amount_2, ComboBox3.Text, amount_3, ComboBox4.Text, amount_4, ComboBox5.Text, amount_5)) And
           (student.addOrderInfo(retailer, today, sum)) Then
    ...
    Private Sub RetailerOrderForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
#Region "確認品項 並將資料傳入Datagridview 1"
...
#Region "計算: 總金額 = 商品單價 * 數量"
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles CalculateButton.Click
        ...
        If rmain.Label2.Text = "happy" Then
            TextBox1.Text = "開開心心服飾店"
        End If
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        TextBoxAmount_1.Text = 2
        TextBoxAmount_2.Text = 3
        TextBoxAmount_3.Text = 4
        TextBoxAmount_4.Text = 5
        TextBoxAmount_5.Text = 6
